...
namespace Unir.Expedientes.Application.Tests.Matriculacion.MatriculaAmpliacionRecuperada.Commands
{
    [Collection("CommonTestCollection")]
    public class CreateMatriculaAmpliacionRecuperadaCommandHandlerTest : TestBase
    {
        #region Handle
        ...
        public async Task Handle_Ok()
        {
            ...
            var sutMock = new Mock<CreateMatriculaAmpliacionRecuperadaCommandHandler>(Context, mockIMediator.Object)
            { CallBase = true };
